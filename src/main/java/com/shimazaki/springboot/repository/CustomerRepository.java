...
public interface CustomerRepository extends JpaRepository<Customer, Long>, JpaSpecificationExecutor<Customer> {
	...
	public List<String> findByFirstNameLikeLimit10(@Param("firstName") String firstName);

	//名 部分検索SQL
	@Query(value = "SELECT last_name FROM customer WHERE last_name LIKE :last_name% LIMIT 10", nativeQuery = true)
	public List<String> findByLastNameLikeLimit10(@Param("lastName") String lastName);
